...
contract JoinWithPenalty {
    // Parameters: (uint 2, uint PENALTY, address NewContract)
    uint constant PENALTY = 10 wei;
    address creator;
    function JoinWithPenalty() {
    ...
    function cancel() {
        ...
        // Idea: for more than 2 players, only remove the first cancelers,
